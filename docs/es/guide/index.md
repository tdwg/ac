...
: Grupo de Trabajo de Recursos Multimedia y Grupo de Mantenimiento del Audiovisual Core de GBIF/TDWG. 2023. Audiovisual Core Guide. Biodiversity Information Standards (TDWG). <http://rs.tdwg.org/ac/doc/guide/2023-02-24>
...
<table>
	<tbody>
		...
		<tr>
			<td>Definition:</td>
			<td>La naturaleza o género del recurso.</td>
		</tr>
		<tr>
			<td>Usage:</td>
