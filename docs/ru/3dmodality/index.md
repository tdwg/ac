...
Последняя версия: http://rs.tdwg.org/ac/doc/3dmodality/
...
Библиографическая ссылка:TDWG Audiovisual Core 3D Enhancement Task Group. Год2026. Controlled Vocabulary for Audiovisual Core 3D Image Capture Modality: List of Terms. Biodiversity Information Standards (TDWG). <http://rs.tdwg.org/ac/doc/3dmodality/2026-08-18>
...
<table>
	...
	<tbody>
		...
		<tr>
			<td>Имеет более широкую концепцию</td>
