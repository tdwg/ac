...
| property | value |
|----------|-------|
| <a id="Commenter"></a><a id="ac:commenter"></a>**Term Name:** | **ac:commenter** |
...
| | |
| <a id="Commenter"></a><a id="ac:commenterLiteral"></a>**Term Name:** | **ac:commenterLiteral** |
...
| | |
| <a id="Comments"></a><a id="ac:comments"></a>**Term Name:** | **ac:comments** |
...
| | |
| <a id="Service_Access_Point"></a><a id="ac:hasServiceAccessPoint"></a>**Term Name:** | **ac:hasServiceAccessPoint** |
...
| | |
| <a id="Metadata_Creator"></a><a id="ac:metadataCreatorLiteral"></a>**Term Name:** | **ac:metadataCreatorLiteral** |
...
| | |
| <a id="Creator"></a><a id="dcterms:creator"></a>**Term Name:** | **dcterms:creator** |
...
| property | value |
|----------|-------|
| <a id="Caption"></a><a id="ac:caption"></a>**Term Name:** | **ac:caption** |
...
| | |
| <a id="Physical_Setting"></a><a id="ac:physicalSetting"></a>**Term Name:** | **ac:physicalSetting** |
...
| | |
| <a id="Subject_Category_Vocabulary"></a><a id="ac:subjectCategoryVocabulary"></a>**Term Name:** | **ac:subjectCategoryVocabulary** |
...
| | |
| <a id="Tag"></a><a id="ac:tag"></a>**Term Name:** | **ac:tag** |
...
| property | value |
|----------|-------|
| <a id="City_or_Place_Name"></a><a id="Iptc4xmpExt:City"></a>**Term Name:** | **Iptc4xmpExt:City** |
...
| | |
| <a id="Country_Code"></a><a id="Iptc4xmpExt:CountryCode"></a>**Term Name:** | **Iptc4xmpExt:CountryCode** |
...
| | |
| <a id="Country_Name"></a><a id="Iptc4xmpExt:CountryName"></a>**Term Name:** | **Iptc4xmpExt:CountryName** |
...
| | |
| <a id="Location_Shown"></a><a id="Iptc4xmpExt:LocationShown"></a>**Term Name:** | **Iptc4xmpExt:LocationShown** |
...
| | |
| <a id="Province_or_State"></a><a id="Iptc4xmpExt:ProvinceState"></a>**Term Name:** | **Iptc4xmpExt:ProvinceState** |
...
| | |
| <a id="Sublocation"></a><a id="Iptc4xmpExt:Sublocation"></a>**Term Name:** | **Iptc4xmpExt:Sublocation** |
...
| | |
| <a id="Higher_Geography"></a><a id="dwc:higherGeography"></a>**Term Name:** | **dwc:higherGeography** |
...
| | |
| <a id="Water_Body"></a><a id="dwc:waterBody"></a>**Term Name:** | **dwc:waterBody** |
...
| property | value |
|----------|-------|
| <a id="Time_of_Day"></a><a id="ac:timeOfDay"></a>**Term Name:** | **ac:timeOfDay** |
...
| | |
| <a id="Original_Date_and_Time"></a><a id="xmp:CreateDate"></a>**Term Name:** | **xmp:CreateDate** |
...
| | |
| <a id="Temporal_Coverage"></a><a id="dcterms:temporal"></a>**Term Name:** | **dcterms:temporal** |
...
| property | value |
|----------|-------|
| <a id="Other_Scientific_Name"></a><a id="ac:otherScientificName"></a>**Term Name:** | **ac:otherScientificName** |
...
| | |
| <a id="Subject_Orientation"></a><a id="ac:subjectOrientation"></a>**Term Name:** | **ac:subjectOrientation** |
...
| | |
| <a id="Subject_Part"></a><a id="ac:subjectPart"></a>**Term Name:** | **ac:subjectPart** |
...
| | |
| <a id="Taxon_Count"></a><a id="ac:taxonCount"></a>**Term Name:** | **ac:taxonCount** |
...
| | |
| <a id="Taxon_Coverage"></a><a id="ac:taxonCoverage"></a>**Term Name:** | **ac:taxonCoverage** |
...
| | |
| <a id="Identification_Qualifier"></a><a id="dwc:identificationQualifier"></a>**Term Name:** | **dwc:identificationQualifier** |
...
| | |
| <a id="Identified_By"></a><a id="dwc:identifiedBy"></a>**Term Name:** | **dwc:identifiedBy** |
...
| | |
| <a id="Subject_Life_Stage"></a><a id="dwc:lifeStage"></a>**Term Name:** | **dwc:lifeStage** |
...
| | |
| <a id="Name_According_To"></a><a id="dwc:nameAccordingTo"></a>**Term Name:** | **dwc:nameAccordingTo** |
...
| | |
| <a id="Subject_Preparation_Technique"></a><a id="dwc:preparations"></a>**Term Name:** | **dwc:preparations** |
...
| | |
| <a id="Scientific_Taxon_Name"></a><a id="dwc:scientificName"></a>**Term Name:** | **dwc:scientificName** |
...
| | |
| <a id="Scientific_Name_ID"></a><a id="dwc:scientificNameID"></a>**Term Name:** | **dwc:scientificNameID** |
...
| | |
| <a id="Subject_Sex"></a><a id="dwc:sex"></a>**Term Name:** | **dwc:sex** |
...
| | |
| <a id="Common_Name"></a><a id="dwc:vernacularName"></a>**Term Name:** | **dwc:vernacularName** |
...
| property | value |
|----------|-------|
| <a id="Capture_Device"></a><a id="ac:captureDevice"></a>**Term Name:** | **ac:captureDevice** |
...
| | |
| <a id="Date_and_Time_Digitized"></a><a id="ac:digitizationDate"></a>**Term Name:** | **ac:digitizationDate** |
...
| | |
| <a id="Resource_Creation_Technique"></a><a id="ac:resourceCreationTechnique"></a>**Term Name:** | **ac:resourceCreationTechnique** |
...
| | |
| <a id="Location_Created"></a><a id="Iptc4xmpExt:LocationCreated"></a>**Term Name:** | **Iptc4xmpExt:LocationCreated** |
...
| property | value |
|----------|-------|
| <a id="Associated_Observation_Reference"></a><a id="ac:associatedObservationReference"></a>**Term Name:** | **ac:associatedObservationReference** |
...
| | |
| <a id="Associated_Specimen_Reference"></a><a id="ac:associatedSpecimenReference"></a>**Term Name:** | **ac:associatedSpecimenReference** |
...
| | |
| <a id="Derived_From"></a><a id="ac:derivedFrom"></a>**Term Name:** | **ac:derivedFrom** |
...
| | |
| <a id="ID_of_Containing_Collection"></a><a id="ac:IDofContainingCollection"></a>**Term Name:** | **ac:IDofContainingCollection** |
...
| | |
| <a id="Provider_ID"></a><a id="ac:providerID"></a>**Term Name:** | **ac:providerID** |
...
| | |
| <a id="Related_Resource_ID"></a><a id="ac:relatedResourceID"></a>**Term Name:** | **ac:relatedResourceID** |
...
| property | value |
|----------|-------|
| <a id="Access_URI"></a><a id="ac:accessURI"></a>**Term Name:** | **ac:accessURI** |
...
| | |
| <a id="Further_Information_URL"></a><a id="ac:furtherInformationURL"></a>**Term Name:** | **ac:furtherInformationURL** |
...
| | |
| <a id="Hash_Function"></a><a id="ac:hashFunction"></a>**Term Name:** | **ac:hashFunction** |
...
| | |
| <a id="Hash"></a><a id="ac:hashValue"></a>**Term Name:** | **ac:hashValue** |
...
| | |
| <a id="Licensing_Exception_Statement"></a><a id="ac:licensingException"></a>**Term Name:** | **ac:licensingException** |
...
| | |
| <a id="Service_Expectation"></a><a id="ac:serviceExpectation"></a>**Term Name:** | **ac:serviceExpectation** |
...
| | |
| <a id="Variant"></a><a id="ac:variant"></a>**Term Name:** | **ac:variant** |
...
| | |
| <a id="Variant_Description"></a><a id="ac:variantDescription"></a>**Term Name:** | **ac:variantDescription** |
...
| | |
| <a id="Variant"></a><a id="ac:variantLiteral"></a>**Term Name:** | **ac:variantLiteral** |
...
| | |
| <a id="Image_Width"></a><a id="exif:PixelXDimension"></a>**Term Name:** | **exif:PixelXDimension** |
...
| | |
| <a id="Image_Height"></a><a id="exif:PixelYDimension"></a>**Term Name:** | **exif:PixelYDimension** |
...
| | |
| <a id="Format"></a><a id="dc:format"></a>**Term Name:** | **dc:format** |
...
| | |
| <a id="Format"></a><a id="dcterms:format"></a>**Term Name:** | **dcterms:format** |
