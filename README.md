...
This is the main entry point to the work of the Audubon Core Maintenance Group.  If you are looking for the landing page of the standard itself, go to <https://www.tdwg.org/standards/ac/>. To find the website containing the standards documents, go to <https://tdwg.github.io/ac/>.
